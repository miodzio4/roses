...
class RosesControllerTest < ActionController::TestCase
  ...
  test "should create rose" do
    assert_difference('Rose.count') do
      post :create, rose: { adr: @rose.adr, cultivation: @rose.cultivation, description: @rose.description, flower_color_desc: @rose.flower_color_desc, flower_color_id: @rose.flower_color_id, flower_shape: @rose.flower_shape, fragrance_id: @rose.fragrance_id, freeze_imm_id: @rose.freeze_imm_id, height_id: @rose.height_id, height_text: @rose.height_text, leaf_spot_imm_id: @rose.leaf_spot_imm_id, leaves_color: @rose.leaves_color, milddew_imm_id: @rose.milddew_imm_id, name: @rose.name, origin: @rose.origin, remarks: @rose.remarks, synonims: @rose.synonims, type_id: @rose.type_id, width: @rose.width, year: @rose.year }
    end
